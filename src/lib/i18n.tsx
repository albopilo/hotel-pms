...
const translations: Record<string, { en: string; id: string }> = {
  ...
  'reports.forward_booking_report': { en: 'Forward Booking Report', id: 'Laporan Pemesanan ke Depan' },
  'reports.pickup_report': { en: 'Pickup Report', id: 'Laporan Pickup' },
  'reports.housekeeping_report': { en: 'Housekeeping Report', id: 'Laporan Housekeeping' },
  'reports.preset_today': { en: 'Today', id: 'Hari Ini' },
  'reports.preset_yesterday': { en: 'Yesterday', id: 'Kemarin' },
  'reports.preset_this_week': { en: 'This Week', id: 'Minggu Ini' },
  'reports.preset_last_week': { en: 'Last Week', id: 'Minggu Lalu' },
  'reports.preset_this_month': { en: 'This Month', id: 'Bulan Ini' },
  'reports.preset_last_month': { en: 'Last Month', id: 'Bulan Lalu' },
  'reports.preset_last_7_days': { en: 'Last 7 Days', id: '7 Hari Terakhir' },
  'reports.preset_last_30_days': { en: 'Last 30 Days', id: '30 Hari Terakhir' },
  'reports.previous_period': { en: 'Previous Period', id: 'Periode Sebelumnya' },
  'reports.current_period': { en: 'Current Period', id: 'Periode Saat Ini' },
  'reports.change_pct': { en: 'Change', id: 'Perubahan' },
  'reports.kpi_summary': { en: 'KPI Summary', id: 'Ringkasan KPI' },
  'reports.room_revenue': { en: 'Room Revenue', id: 'Pendapatan Kamar' },
  'reports.ancillary_revenue': { en: 'Ancillary Revenue', id: 'Pendapatan Tambahan' },
  'reports.total_revenue': { en: 'Total Revenue', id: 'Total Pendapatan' },
  'reports.reservations_count': { en: 'Reservations', id: 'Reservasi' },
  'reports.room_nights_short': { en: 'Room Nights', id: 'Malam Kamar' },
  'reports.avg_stay_nights': { en: 'Avg Stay (nights)', id: 'Rata-rata Menginap (malam)' },
  'reports.settled': { en: 'Settled', id: 'Disettle' },
  'reports.pending': { en: 'Pending', id: 'Tertunda' },
  'reports.gross_revenue': { en: 'Gross Revenue', id: 'Pendapatan Kotor' },
  'reports.settled_amount': { en: 'Settled Amount', id: 'Jumlah Disettle' },
  'reports.pending_amount': { en: 'Pending Amount', id: 'Jumlah Tertunda' },
  'reports.movement_type': { en: 'Movement Type', id: 'Jenis Pergerakan' },
  'reports.approver': { en: 'Approver', id: 'Pemberi Persetujuan' },
  'reports.from_room': { en: 'From Room', id: 'Dari Kamar' },
  'reports.to_room': { en: 'To Room', id: 'Ke Kamar' },
  'reports.transferred_by': { en: 'Transferred By', id: 'Dipindahkan Oleh' },
  'reports.status_distribution': { en: 'Status Distribution', id: 'Distribusi Status' },
  'reports.nationality_breakdown': { en: 'Nationality Breakdown', id: 'Rincian Kewarganegaraan' },
  'reports.gender_breakdown': { en: 'Gender Breakdown', id: 'Rincian Jenis Kelamin' },
  'reports.repeat_guests': { en: 'Repeat Guests', id: 'Tamu Berulang' },
  'reports.new_guests': { en: 'New Guests', id: 'Tamu Baru' },
  'reports.total_guests': { en: 'Total Guests', id: 'Total Tamu' },
  'reports.net_pickup': { en: 'Net Pickup', id: 'Net Pickup' },
  'reports.new_reservations': { en: 'New Reservations', id: 'Reservasi Baru' },
  'reports.cancelled_reservations': { en: 'Cancelled', id: 'Dibatalkan' },
  'reports.expected_occupancy': { en: 'Expected Occupancy', id: 'Hunian Diperkirakan' },
  'reports.expected_revenue': { en: 'Expected Revenue', id: 'Pendapatan Diperkirakan' },
  'reports.debit': { en: 'Debit', id: 'Debit' },
  'reports.credit': { en: 'Credit', id: 'Kredit' },
  'reports.running_balance': { en: 'Running Balance', id: 'Saldo Berjalan' },
  'reports.transaction_type': { en: 'Transaction Type', id: 'Jenis Transaksi' },
  'reports.print_report': { en: 'Print Report', id: 'Cetak Laporan' },
  'reports.generated_on': { en: 'Generated on', id: 'Dibuat pada' },
  'reports.no_room_transfers': { en: 'No room transfers found', id: 'Tidak ada pemindahan kamar' },
  'reports.group_front_office': { en: 'Front Office', id: 'Front Office' },
  'reports.group_financial': { en: 'Financial', id: 'Keuangan' },
  'reports.group_management': { en: 'Management', id: 'Manajemen' },
